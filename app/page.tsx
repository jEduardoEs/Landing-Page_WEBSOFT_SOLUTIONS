        ...
        <div style={{ maxWidth: 1140, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 2 }} className="four-col-services">
            {[
              ...
              { n: '03', title: 'Aires Acondicionados', desc: 'Venta e instalación de aires acondicionados para hogar y negocio. Mantenimiento, recarga de gas y reparación de unidades.', img: '/galeria/Foto16.jpeg', href: null },
        ...
        <div style={{ maxWidth: 800, margin: '0 auto', textAlign: 'center' }}>
          <div className="fade-up">
            ...
            <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
              <button onClick={() => openWA()} style={{ background: '#25D366', color: '#fff', border: 'none', padding: '16px 36px', borderRadius: 4, fontSize: 15, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', letterSpacing: .5, display: 'flex', alignItems: 'center', gap: 10 }}>
