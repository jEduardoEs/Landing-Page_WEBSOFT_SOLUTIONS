        ...
        <div style={{ maxWidth: 1140, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 2 }} className="three-col">
            {[
              ...
              { n: '02', title: 'PC y Laptops', desc: 'Mantenimiento preventivo y correctivo, reparación de hardware y pantallas, instalación de software y recuperación de datos. Diagnóstico gratuito.', img: '/galeria/Foto3.jpeg', href: null },
              { n: '03', title: 'Venta de Tecnología', desc: 'Catálogo completo de periféricos, accesorios, cables y componentes. Todo con garantía y precio justo.', img: '/galeria/Foto4.jpeg', href: '/catalogo' },
            ].map(s => (
